...
class ImageValue : public QObject
{
    ...
    Q_PROPERTY(QString sbLevel READ getsbLevel WRITE setsbLevel NOTIFY sbLevelChanged)
...
public:
    ...
    QString getsbLevel(void) const;
    void setsbLevel(const QString sbLevel);
